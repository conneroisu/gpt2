...
// Train trains a BPE tokenizer from the given text. The given vocabSize is the target
// vocabulary size to learn (total number of tokens the encoder will use,
// including 256 initial tokens for single-byte letters. The given splitPattern is
