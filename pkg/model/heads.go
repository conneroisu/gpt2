...
// //
// // If k is true, the matrix is permuted as (batch, seq_length, n_head, head_features) -> (batch, n_head, head_features, seq_length).
// // If k is false, the matrix is permuted as (batch, seq_length, n_head, head_features) -> (batch, n_head, seq_length, head_features).
...
//                         for j := 0; j < a.NHead; j++ {
//                                 for l := 0; l < headSize; l++ {
//                                         result.Set(j, i+l*rows, x.At(i, j*headSize+l))
//                                 }
//                         }
//                 }
//         }
